...
- Vault
date: 2023-03-07
image: "/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes.png"
featured: true
---
...
{{< callout type="tip" text="This blog was published just before HashiCorp released their [Vault Secrets Operator](https://github.com/hashicorp/vault-secrets-operator). We have not found the time to update this comparison to include it, sorry about that." >}}
...
![k8s-use-case](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-use-case.png)
...
![k8s-use-case-problems](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-use-case-problems.png)
...
{{< callout type="tip" text="It is a really good idea to use a secrets manager that is <strong>automation-friendly</strong> to avoid secret sprawl and help prevent compromised credentials. And this is where HashiCorp Vault excels." >}}
...
![k8s-goal](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-goal.png)
...
![k8s-vault-rest-api](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-vault-rest-api.png)
...
![k8s-vault-sidecar-injector](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-vault-sidecar-injector.png)
...
![k8s-vault-csi-provider](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-vault-csi-provider.png)
...
![k8s-external-secrets-operator](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-external-secrets-operator.png)
...
![k8s-argocd-vault-plugin](/blog/comparing-methods-for-accessing-secrets-in-vault-from-kubernetes/k8s-argocd-vault-plugin.png)
